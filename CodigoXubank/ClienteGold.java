...
public class ClienteGold extends Cliente {
    ...
    private final double mensalidade = 10;
    ...
    public ClienteGold(String nome, int cpf, String senha) {
    ...
    public void depositar(int id, Double valor){
        ...
        for(Conta c : getContas()){
            if (c.getIdConta() == id){
                div1 = (int)c.getSaldo()/1000;
                c.setSaldo(c.getSaldo()+valor);
                div2 = (int)c.getSaldo()/1000;
                if(div1!=div2)
                    aplicaFidelidade();
            }
        }
    ...
    public void aplicaFidelidade(){
        setPontosFidelidade(getPontosFidelidade()+10);
    }
